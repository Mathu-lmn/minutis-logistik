...
export const demands: Demand[] = [
  ...
  },
  {
    ...
    statusHistory: [{ status: DemandStatus.Pending, timestamp: 1712577345000 }],
    assigned: false,
  ...
  },
  {
    id: 6,
    status: DemandStatus.Pending,
    statusHistory: [{ status: DemandStatus.Pending, timestamp: 1712712237000 }],
    assigned: false,
    priority: DemandPriority.Low,
  ...
  },
  {
    id: 8,
    status: DemandStatus.Pending,
    statusHistory: [{ status: DemandStatus.Pending, timestamp: 1712598157000 }],
    assigned: false,
    priority: DemandPriority.Medium,
